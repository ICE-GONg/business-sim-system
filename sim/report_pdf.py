...
def build_round_report_pdf(
    ...
    story: list[Any] = [
        ...
        *notes([
            "Low-salary Effect: salaries below the market average reduce effective employee productivity.",
            "Layoff Cost: layoffs are charged as compensation and are shown separately in Finance.",
            "Salary-reduction / Quitting: automatic quits are zero in the current simulator; salary affects effective staffing.",
